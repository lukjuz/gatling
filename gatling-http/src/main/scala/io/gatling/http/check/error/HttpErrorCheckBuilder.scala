...
package io.gatling.http.check.error
...
object HttpErrorCheckBuilder {
  ...
  val Error: DefaultFindCheckBuilder[HttpErrorCheckType, HttpFailure, String] = {
    ...
    new DefaultFindCheckBuilder[HttpErrorCheckType, HttpFailure, String](errorStringExtractor, displayActualValue = true)
  }
}
